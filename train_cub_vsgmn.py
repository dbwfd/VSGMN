...
wandb.init(project='GCN', config='wandb_config/cub_czsl_gcn_best_plot.yaml')
config = wandb.config
...
att = dataloader.att
att[att<0] = 0
# prototype=att.detach().cpu().numpy
...
for i in range(0, niters):
    ...
    if i % report_interval == 0:
        ...
        if acc_zs > best_performance_zsl:
            ...
            #torch.save(model.state_dict(), "./data/parameter/model_cub_best.pkl")
